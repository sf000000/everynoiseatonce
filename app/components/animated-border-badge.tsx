...
export default function AnimatedBorderBadge({
  ...
  return (
    ...
    >
      ...
      <span className="select-none inline-flex h-full w-full items-center justify-center rounded-full bg-popover px-2 py-[1px] text-sm font-medium backdrop-blur-3xl">
        {label}
      </span>
    </div>
  );
